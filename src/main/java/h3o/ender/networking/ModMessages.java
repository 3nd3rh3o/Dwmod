...
import h3o.ender.networking.packets.TardisMainConfC2Spacket;
...
public class ModMessages {
    ...
    public static final Identifier TARDIS_MAIN_CONF_ID = new Identifier(DwMod.MODID, "tardis_main_conf");
    ...
    public static void registerC2Spackets() {
        ...
        ServerPlayNetworking.registerGlobalReceiver(TARDIS_MAIN_CONF_ID, TardisMainConfC2Spacket::receive);
    }
