...
public class RegisterScreenHandler {
    ...
    public static final ScreenHandlerType<MaintenanceConfigScreenHandler> MAINTENANCE_CONF_SCREEN_HANDLER = new ExtendedScreenHandlerType<>(MaintenanceConfigScreenHandler::new);
    ...
    public static void register() {
        ...
        Registry.register(Registries.SCREEN_HANDLER, new Identifier(DwMod.MODID, "tardis_maintenance_config"), MAINTENANCE_CONF_SCREEN_HANDLER);
    }
}
